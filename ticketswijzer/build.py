#!/usr/bin/env python3
"""
TicketsWijzer static-site generator.
...
Add an attraction by editing data/attractions.json, then run:  python3 build.py
"""
...
def foot(root, site):
  ...
  <div>{esc(site['domain'])} · voorbeelddata</div>
</div></footer>
</body></html>"""
...
<main class="wrap detail-body">
  ...
  <div class="disclaimer">\U0001F4A1 Voorbeelddata. De “Naar ticket”-knoppen worden affiliate-links (rel=\"sponsored\"). Prijzen worden vóór lancering geverifieerd en daarna automatisch bijgewerkt.</div>
</main>
""" + foot("../", site)
